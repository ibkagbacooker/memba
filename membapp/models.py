...
class Topics(db.Model):
    ...
    all_comments = db.relationship("Comments", back_populates="the_topic", cascade="all , delete-orphan") #fri commit 1
...
class Donation(db.Model):
    ...
    dooooon= db.relationship('User',backref='mydonations')
...
#TO DO: go to the command Line, activate your virtual environment 
#activate python shell bt typing python
#from membapp import db, models,app
